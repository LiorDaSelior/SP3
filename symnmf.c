...
double calc_frobenius(Matrix* mat1 , Matrix* mat2) { // mat1 is (i+1) - assume same dimensions
    double total = 0;
...
Matrix* create_ass_matrix(Matrix* h_matrix, Matrix* norm_matrix, double beta, int iter, double eps) { // frees original H
    int i = 0;
    int check = 0;
